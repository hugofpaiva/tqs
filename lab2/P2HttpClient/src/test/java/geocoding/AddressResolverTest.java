...
class AddressResolverTest {
    ...
    public void whenBadCoordinates_throwBadArrayIndex() throws IOException, URISyntaxException, ParseException {
        when(httpClient.get(contains("location=220.000000%2C-220.000000"))).thenThrow(IndexOutOfBoundsException.class);
